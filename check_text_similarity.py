...
class TextSimilarity:
    ...
    def calc_similarity(self, word1, word2, filter_emoji=True, punctuation=False):
        # 经测试，去与不去表情符号，得到的值是相同的，可能jieba库对表情符号做了处理
        if filter_emoji:
            self.word1 = utils.filter_emoji(word1)
            self.word2 = utils.filter_emoji(word2)
        else:
            self.word1 = word1
            self.word2 = word2
